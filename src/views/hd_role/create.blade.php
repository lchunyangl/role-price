...
@section('content')
    <div style="padding: 30px;">
        {!! Form::open(['route'=>['hd_role.store'],'method'=>'post','class'=>'layui-form layui-form-pane','autocomplete'=>'off']) !!}
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input class="layui-input" type="text" placeholder="" name="name">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="layui-input-inline">
                    <input type="text" name="start_time" placeholder=""
                           autocomplete="off" class="layui-input datetime-picker">
                </div>
        ...
        <div class="layui-form-item" id="region_ids">
            ...
            <div class="layui-input-block add_region" style="display:none;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                @foreach(user_rank() as $k=>$v)
                    <input type="checkbox" name="rank_ids[]" value="{{$k}}" title="{{$v}}">
                @endforeach
            </div>
        </div>
        <div class="layui-form-item" id="user_ids">
            ...
            <div class="layui-input-block add_users" style="display: none;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                ...
                <input type="radio" name="is_enabled" value="0" title="关闭" checked>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
